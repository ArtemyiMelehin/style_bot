...
Предварительно скачаны веса предобученных моделей из [хранилища](http://efrosgans.eecs.berkeley.edu/cyclegan/pretrained_models/)
...
В работе используются веса двух предобученных моделей: style_vangogh.pth  и winter2summer_yosemite.pth
