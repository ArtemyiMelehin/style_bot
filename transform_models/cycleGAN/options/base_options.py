...
обрабатывала его генератором и сразу возвращала результат.
"""
...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # basic parameters
        parser.add_argument('--dataroot', required=None, help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
